...
Tras la ejecución exitosa, la carpeta `output/` contendrá los siguientes archivos, listos para ser cargados en un entorno de producción (e.g., el **BL\_00\_7 Kafka Monitor**):
